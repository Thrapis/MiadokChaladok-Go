...
import { GetFilterLists, IFilterForm, IFilterLists } from 'shared/api/catalog'
...
type Props = {
    onFilterChange: (data: IFilterForm) => {}
}
...
export const CatalogFilter = ({
    ...
    const [catalogFilters, setCatalogFilters] = useState<IFilterLists>()

    const [defaultFilter, setDefaultFilter] = useState<IFilterForm>()
    const [lastFilter, setLastFilter] = useState<IFilterForm>()
    ...
    async function fetchFilterLists() {
        ...
        const filterLists = response.data.payload
    ...
    const onFilterFormSubmit: SubmitHandler<IFilterForm> = (filter) => {
